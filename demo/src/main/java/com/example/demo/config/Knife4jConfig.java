 ...
 * @author 曳戈泰尔
 * @version 1.0
 * @description 作用: 自动生成API文档和在线接口调试工具
 * @date 2022/8/14 4:56 PM
 */
@Configuration
...
public class Knife4jConfig {
     ...
     *
     * <p>RequestHandlerSelectors,配置要扫描接口的方式 basePackage：指定扫描的包路径 any：扫描全部 none：全部不扫描
     * withClassAnnotation:扫描类上的注解，如RestController withMethodAnnotation:扫描方法上的注解，如GetMapping
     *
     * @return
     */
        ...
        return new Docket(DocumentationType.OAS_30)
                ...
                .apis(
                        RequestHandlerSelectors.basePackage(
                                "com.example.demo.controller")) // 这里采用包扫描的方式来确定要显示的接口
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .contact(
                        new Contact(
                                "曳戈泰尔", "http://127.0.0.1:8081/doc.html", "yegetaier7977@qq.com"))
                .version("v1.0")
                .title("API文档")
                // 服务Url
