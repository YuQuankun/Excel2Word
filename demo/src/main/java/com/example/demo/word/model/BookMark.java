...
public class BookMark {
    ...
    private String bookMark1 =
            "<aml:annotation aml:id=\"0\" w:name=\"分割1\" w:type=\"Word.Bookmark.Start\"/>"
    ...
    private String bookMark4 =
            "<aml:annotation aml:id=\"3\" w:name=\"分割4\" w:type=\"Word.Bookmark.Start\"/>"
                    + "<aml:annotation aml:id=\"3\" w:type=\"Word.Bookmark.End\"/>";

    /** 分割书签5 */
    private String bookMark5 =
            "<aml:annotation aml:id=\"4\" w:name=\"分割5\" w:type=\"Word.Bookmark.Start\"/>"
                    + "<aml:annotation aml:id=\"4\" w:type=\"Word.Bookmark.End\"/>";

    /** 分割书签6 */
    private String bookMark6 =
            "<aml:annotation aml:id=\"5\" w:name=\"分割6\" w:type=\"Word.Bookmark.Start\"/>"
                    + "<aml:annotation aml:id=\"5\" w:type=\"Word.Bookmark.End\"/>";

    /** 分割书签7 */
    private String bookMark7 =
            "<aml:annotation aml:id=\"6\" w:name=\"分割7\" w:type=\"Word.Bookmark.Start\"/>"
